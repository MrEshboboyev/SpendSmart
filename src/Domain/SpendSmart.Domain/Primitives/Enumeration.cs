...
namespace SpendSmart.Domain.Primitives;
...
public abstract class Enumeration<TEnum> : 
    ...
    IComparable<Enumeration<TEnum>> where TEnum : Enumeration<TEnum>
{
    ...
    /// <inheritdoc />
    public int CompareTo(Enumeration<TEnum> other) => other is null 
        ? 1 
