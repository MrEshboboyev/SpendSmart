...
using SpendSmart.Domain.Utility;
using System;
...
public sealed class Budget : Entity, IAuditableEntity
{
    ...
    private Budget(User user,
                   ...
                   DateTime startDate,
                   DateTime endDate) : base(Ulid.NewUlid())
    {
    ...
    private static void EnsureStartDatePrecedesEndDate(DateTime startDate,
                                                       DateTime endDate)
    {
    ...
    private static void EnsureMoneyIsGreaterThanZero(Money money) =>
        Ensure.NotLessThanOrEqualToZero(
            money.Amount, 
