...
namespace SpendSmart.Persistence.Extensions;
...
internal static class RavenQueryableExtensions
{
    ...
    internal static IRavenQueryable<T> WithNoTracking<T>(this IRavenQueryable<T> query) 
        => query.Customize(x => x.NoTracking());
}
