...
using SpendSmart.Domain.UnitTests.TestData.Passwords;
using SpendSmart.Domain.UnitTests.TestData.Users;
using System;
using Xunit;

namespace SpendSmart.Domain.UnitTests.Modules.Users;
...
public class UserTests
{
        ...
        string paramName)
    {
        // Arrange
        // Act
        void action() => User.Create(firstName, lastName, email, password, default);
    ...
    public void Create_ShouldThrowArgumentNullException_WhenPasswordIsNull()
    {
        // Arrange
        // Act
        static void action() => User.Create(UserTestData.FirstName, UserTestData.LastName, UserTestData.Email, UserTestData.Password, null);
