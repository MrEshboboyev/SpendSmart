...
using SpendSmart.Domain.Modules.Transactions.Events;
using SpendSmart.Domain.Modules.Transactions.Exceptions;
...
public class TransactionTests
{
        ...
        string paramName)
    {
        // Arrange
        // Act
        void action() => Transaction.Create(user, transactionDetails);
